...
public class ap7_phpmyadmin_docker {

    @Test(priority = 1)
    public void ap7_phpmyadmin_Status() {
        ...
        try {
            ...
            if (!isRunning) {
                sendEmailAlert("Hi,\n\n🚨 This is ap7 phpmyadmin Docker. I am currently down. Kindly restart the container at your earliest convenience.");
    ...
    public void sendEmailAlert(String messageBody) {
        ...
        String subject = "Docker Container Alert - ap7 phpmyadmin docker";
